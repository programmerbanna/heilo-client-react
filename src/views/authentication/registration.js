...
import { CheckBox } from "shared/components/input/input";
          ...
          */}
                    <div className="form-modal z-20 -mt-8">
                        ...
                        <div className="mx-9 my-4 flex flex-col items-center min-w-xs">
                            ...
                            <SelectBox placeholder="Gender" options={options} defaultValue={gender} className='outline-none' onChange={(e) => console.log(e.value)} />
                            <InputBox
