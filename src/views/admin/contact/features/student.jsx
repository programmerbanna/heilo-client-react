            ...
            <div className="flex flex-col-reverse md:grid md:grid-cols-12 gap-16">
                <div className=" md:col-span-7">
                    <div className=" flex flex-col-reverse md:flex-row justify-between gap-3">
                        <div className=" flex flex-row md:flex-col justify-between gap-2 mb-4">
                        ...
                        <div className=" w-full md:w-[336px] px-5 bg-[#fff] h-[35px] rounded-[30px] flex justify-center items-center">
                            <input
                                type="text"
                ...
                <div className="md:col-span-5 relative before:absolute before:content-[' '] before:w-[3px] before:h-full before:bg-white before:top-0 before:-left-[31px] before:rounded-full">
                    <UserRightComponents
