...
export const MobileTable = () => {
    ...
    return (
        <div className=" w-full flex flex-col gap-3 pt-5 bg-[#EBEBEB] rounded-xl relative">
            <div className=" absolute -top-5 left-0 py-2 px-5 bg-white rounded-full">
                <span className=" font-semibold text-sm leading-7 text-textSecondary">
                    Payment history
                </span>
            </div>
            <div className=" flex flex-row mx-auto w-full px-[19px] sticky top-0 z-40 py-2">
            ...
            <div className=" w-full pb-5 px-5">
                <Scrollbar className="w-full h-[370px] !rounded-xl !pr-0">
                    <div className=" flex flex-col mx-auto w-full bg-white ">
