        ...
        <div className={clx("w-1/3 h-full relative")}>
          ...
          >
            {tableHeader?.slice(2)?.map((e, i) => (
              <option className="text-xs" key={i} value={e?.label}>
                {e.label}
              </option>
            ))}
          </select>
            ...
            >
              ...
              <div
                className={clx(
                  ...
                  filterTable === "duration" ? "block" : "hidden"
                )}
              >
                <span
                  className={clx("text-[#616161] font-semibold text-[10px]")}
                >
                  {element?.duration}
                </span>
              </div>
              <div
                className={clx(
                  "w-1/3 p-2.5 border-r border-transparent",
                  filterTable === "amount" ? "block" : "hidden"
                )}
              >
                <span
                  className={clx(
                    "font-semibold text-[10px]",
                    element?.grow ? "text-primaryLight" : "text-[#BA0B2B]"
                  )}
                >
                  {element?.amount}
                </span>
              ...
              <div
                className={clx(
                  ...
                  filterTable === "total balance" ? "block" : "hidden"
                )}
              >
