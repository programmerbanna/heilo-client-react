      ...
      {data !== undefined && (
        <section className="grid grid-rows-1 md:grid-cols-12 gap-6 mt-3">
          <div className="md:col-span-4 ">
            {/* <StudentInfoCard userData={result} /> */}
          </div>
              ...
              <div className="grayDiv p-4 rounded-3xl mt-4">
                ...
                <div className="grid grid-rows-1 md:grid-cols-12 gap-4">
                  <div className="md:col-span-6 p-4 pb-0">
                    ...
                    <p className="text-[#7D7D7D] font-semibold">
                      {data?.result?.currentInstitution?.name}
                    </p>
                  </div>
                  <div className="md:col-span-6 p-4 pb-0">
                    <h1 className="font-light text[#7D7D7D] mb-1.5">Class</h1>
                    <p className="text-[#7D7D7D] font-semibold">
                      {data?.result?.currentInstitution?.class}
                    </p>
                  </div>
                </div>
                ...
                <div className="grid  grid-rows-1 md:grid-cols-12 gap-4">
                  <div className="md:col-span-6 p-4 pb-0">
                    ...
                    <p className="text-[#7D7D7D] font-semibold">
                      {data?.result?.currentInstitution?.medium}
                    </p>
                  </div>
                  <div className="md:col-span-6 p-4 pb-0">
                    <h1 className="font-light text[#7D7D7D] mb-1.5">
                    ...
                    <p className="text-[#7D7D7D] font-semibold">
                      {data?.result?.currentInstitution?.background}
                    </p>
                  </div>
                </div>
              </div>
